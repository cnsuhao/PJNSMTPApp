...
History: PJN / 01-08-2014 1. Initial public release
         PJN / 17-04-2017 1. Added support for CryptSignAndEncodeCertificate to the CCNGKey class
                          2. Added support for CryptSignCertificate to the CCNGKey class
...
#endif //#ifdef CMSG_SIGNER_ENCODE_INFO_HAS_IUM_FIELDS
