/*
Module : CryptoWrappersCertificate.h
...
History: PJN / 01-08-2014 1. Initial public release
         PJN / 21-09-2014 1. Added missing include of CryptoWrapperHelpers.h
...
#ifndef __CRYPTOWRAPPERSCERTIFICATE_H__
#define __CRYPTOWRAPPERSCERTIFICATE_H__

#pragma comment(lib, "Crypt32.lib")  //Automatically link in the Crypto dll
#pragma comment(lib, "Cryptui.lib")  //Automatically link in the Crypto UI dll
...
#pragma message("To avoid this message, please put cryptuiapi.h in your pre compiled header (normally stdafx.h)")
#include <cryptuiapi.h>
#endif //#ifndef __CRYPTUIAPI_H__
#include "CryptoWrappersHelpers.h"
...
#endif //#ifndef __CRYPTOWRAPPERSCERTIFICATE_H__
